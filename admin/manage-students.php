								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									<thead>
										<tr>
										    ...
										    <center>
<input type="button" value="print all Details" onclick=Javascript:window.print()>
</center>
...
<td>
<a href="javascript:void(0);"  onClick="popUpWindow('full-profile.php?id=<?php echo $row->emailid;?>');" title="View Full Details">Print&nbsp;&nbsp;&nbsp;&nbsp;</a>
